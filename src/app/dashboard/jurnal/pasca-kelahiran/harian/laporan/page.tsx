...
const labelMap: Record<string, string> = {
  asiEksklusif: "ASI Eksklusif",
  mpasi: "MPASI",
  lemakTambahan: "Lemak Tambahan",
  karbohidratProteinNabati: "Karbohidrat dan Protein Nabati",
  sayuranBuah: "Sayuran dan Buah",
  garamBeryodium: "Garam Beryodium",
  zatBesiVitaminD3: "Vitamin D3 dan Zat Besi",
  polaBabBak: "Pola BAB dan BAK",
}

export default function LaporanHarianPascaKelahiranPage() {
  const router = useRouter()
  const data = useJurnalStore((state) => state.harianPascaKelahiran)

  useEffect(() => {
    if (!data) {
      router.replace("/dashboard/jurnal/pasca-kelahiran/harian")
    }
  }, [data, router])
  ...
  return (
    <div className="flex w-full h-full justify-center lg:py-8">
      <div className="flex flex-col w-full max-w-2xl px-4 lg:px-0">
        ...
        <h2 className="text-xl font-medium text-neutral-800 mb-8 text-center">Laporan Harian</h2>
        ...
        <Link
          href="/dashboard/jurnal/pasca-kelahiran/harian"
